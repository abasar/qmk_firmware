...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_2, KC_A, KC_S, KC_D, KC_F, KC_G,                                        KC_H   , KC_J  , KC_K  ,  KC_L  , KC_3  ,  KC_4,
        KC_3, KC_Z, KC_X, KC_C, KC_V, KC_B,                                        KC_N   , KC_M  , KC_5  ,  KC_6  , KC_7  ,  KC_8,
        KC_4, KC_5, KC_6, KC_7, KC_8,                                                       KC_1  , KC_2  ,  KC_3  , KC_4  ,  KC_5  ,
                                            KC_1, KC_2,                     KC_1, KC_2,
                                                  KC_3,                     KC_3,
